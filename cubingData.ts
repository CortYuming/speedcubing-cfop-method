export const CUBING_DATA:string[] = [
  ...
  "PLL	09Z	M U M2' U M2' U M U2 M2' U'	M U M2' U M2' U M U2 M2' U'	",
  ...
  // OLL
  "OLL	Line to Cross	F (R U R' U') F'	F (R U R' U') F'	F (R U R' U') F' F (R U R' U') F'",
  ...
  "OLL	26	R U2' R' U' R U' R'	R U2' R' U' R U' R'	",
  "OLL	27	(R U R') U R U2 R'	(R U R') U R U2 R'	",
  // "				",
  // replace: [("’", "'"),("'2", "2'")]
];
